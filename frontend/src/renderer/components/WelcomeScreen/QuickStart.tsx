...
import { Utensils, Globe, Heart, Star, Coffee, MapPin, Music, Gift, Sun, Moon, Plane, Book, Gamepad2, Palette, ShoppingBag, Leaf, Film, Dumbbell, Brain, Lightbulb, Camera, Calendar, House, Sparkles, Mail, Search, FileText, Zap } from 'lucide-react';
...
export type ColorName = 'emerald' | 'orange' | 'blue' | 'purple' | 'pink' | 'cyan' | 'amber' | 'rose' | 'teal' | 'yellow';

const colorMap: Record<ColorName, { bg: string; border: string; icon: string; glow: string }> = {
    emerald: { bg: 'hover:bg-emerald-500/5', border: 'hover:border-emerald-500/30', icon: 'text-emerald-400', glow: 'group-hover:shadow-emerald-500/50' },
    orange: { bg: 'hover:bg-orange-500/5', border: 'hover:border-orange-500/30', icon: 'text-orange-400', glow: 'group-hover:shadow-orange-500/50' },
    blue: { bg: 'hover:bg-blue-500/5', border: 'hover:border-blue-500/30', icon: 'text-blue-400', glow: 'group-hover:shadow-blue-500/50' },
    purple: { bg: 'hover:bg-purple-500/5', border: 'hover:border-purple-500/30', icon: 'text-purple-400', glow: 'group-hover:shadow-purple-500/50' },
    pink: { bg: 'hover:bg-pink-500/5', border: 'hover:border-pink-500/30', icon: 'text-pink-400', glow: 'group-hover:shadow-pink-500/50' },
    cyan: { bg: 'hover:bg-cyan-500/5', border: 'hover:border-cyan-500/30', icon: 'text-cyan-400', glow: 'group-hover:shadow-cyan-500/50' },
    amber: { bg: 'hover:bg-amber-500/5', border: 'hover:border-amber-500/30', icon: 'text-amber-400', glow: 'group-hover:shadow-amber-500/50' },
    rose: { bg: 'hover:bg-rose-500/5', border: 'hover:border-rose-500/30', icon: 'text-rose-400', glow: 'group-hover:shadow-rose-500/50' },
    teal: { bg: 'hover:bg-teal-500/5', border: 'hover:border-teal-500/30', icon: 'text-teal-400', glow: 'group-hover:shadow-teal-500/50' },
    yellow: { bg: 'hover:bg-yellow-500/5', border: 'hover:border-yellow-500/30', icon: 'text-yellow-400', glow: 'group-hover:shadow-yellow-500/50' },
};
