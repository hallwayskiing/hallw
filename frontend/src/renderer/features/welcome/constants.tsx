import { Utensils, Globe, Heart, Star, Coffee, MapPin, Music, Gift, Sun, Moon, Plane, Book, Gamepad2, Palette, ShoppingBag, Leaf, Film, Dumbbell, Brain, Lightbulb, Camera, Calendar, House, Sparkles, Mail, Search, FileText } from 'lucide-react';
