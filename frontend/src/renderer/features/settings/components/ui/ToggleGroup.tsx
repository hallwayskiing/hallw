...
export function ToggleGroup({ id, label, desc, checked, onChange, color }: { id: string; label: string; desc?: string; checked: boolean; onChange: (checked: boolean) => void; color?: string }) {
    return (
